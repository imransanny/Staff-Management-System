        ...
        <ol>
          ...
          <li>নতুন ইভেন্ট</li>
            ...
            <div style="text-align: center; background: linear-gradient(180deg, #d5a8a8, #263550);">
                ...
                <form style="padding: 10%;" action="code.php" method="POST">
                
                <h1  class="h3 mb-3 fw-normal">নতুন ইভেন্ট</h1>
                
                <div class="form-floating">
                <input type="text" class="form-control" name= "name" id="floatingInput" placeholder="name@example.com">
                <label for="floatingInput">ইভেন্ট নাম</label>
                </div>
                
                <div class="form-floating">
                <input type="text" class="form-control" name = "venue" id="floatingPassword" placeholder="Password">
                <label for="floatingPassword">ইভেন্ট স্থান</label>
                </div>

                <div class="form-floating">
                <input type="date" class="form-control" name = "date" id="floatingPassword" placeholder="Password">
                <label for="floatingPassword">ইভেন্ট তারিখ</label>
                </div>

                
                <button class="w-100 btn btn-lg btn-primary" type="submit" name = "event">জমা দিন</button>
