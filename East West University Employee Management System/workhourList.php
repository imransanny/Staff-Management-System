      ...
      <div class="container position-relative d-flex flex-column align-items-center" data-aos="fade">
        ...
        <ol>
          ...
          <li>কাজের সময়</li>
            ...
            <?php 
                                    $query = "SELECT * FROM workhour";
                                    $query_run = mysqli_query($con, $query);

                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $workhour)
                                        {
                                            ?>
                                            <tr>
                                                <td><?= $workhour['name']; ?></td>
                                                <td><?= $workhour['phone']; ?></td>
                                                <td><?= $workhour['inTime']; ?></td>
                                                <td><?= $workhour['outTime']; ?></td>
                                                
                                                <td>
                                                    <a href="employeeProfile.php?id=<?= $workhour['phone']; ?>" class="btn btn-info btn-sm">View</a>
                                                   
                                                    <form action="code.php" method="POST" class="d-inline">
                                                        <button type="submit" name="delete_workhour" value="<?=$workhour['phone'];?>" class="btn btn-danger btn-sm">Delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php
