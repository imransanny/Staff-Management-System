                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $employee)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $employee['dob']; ?></td>
                                                <td>
                                                    <a href="employeeProfile.php?id=<?= $employee['phone']; ?>" class="btn btn-info btn-sm">View</a>
                                                    <a href="employeeEdit.php?id=<?= $employee['nid']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                    <form action="code.php" method="POST" class="d-inline">
                                                        <button type="submit" name="delete_student" value="<?=$employee['nid'];?>" class="btn btn-danger btn-sm">Delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php
