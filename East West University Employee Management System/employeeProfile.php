  ...
  <main id="main">
    ...
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('project_photos/jpeg/breadCrums.jpg');">
      <div class="container position-relative d-flex flex-column align-items-center" data-aos="fade">
        ...
        <ol>
          ...
          <li>আমার প্রোফাইল</li>
            ...
            <div style="text-align: center; background: linear-gradient(180deg, #d5a8a8, #263550);">
            
            <?php
            if(isset($_GET['id'])){
              $phone = mysqli_real_escape_string($con, $_GET['id']);
              $query = "SELECT * FROM employee WHERE phone='$phone' ";
              $query_run = mysqli_query($con, $query);
            
              if(mysqli_num_rows($query_run) > 0){

                foreach($query_run as $empolyee){
          ...
          <form style="padding: 10%;" >
                  ...
                  <label >National ID</label>
                    <input type="number" name="nid" value = "<?php echo $empolyee['nid']; ?>" class="form-control form-control-lg" disabled />
                    
                  </div>
    
                  <div class="form-outline mb-4">
                  <label class="form-label" for="form3Example1cg">Your Name</label>
                    <input type="name" name="name" value = "<?php echo $empolyee['name']; ?>" class="form-control form-control-lg" disabled/>
                    
                  </div>
    
                  <div class="form-outline mb-4">
                  <label class="form-label" for="form3Example1cg">Your Email</label>  
                  <input type="email" name="email" value = "<?php echo $empolyee['email']; ?>" class="form-control form-control-lg" disabled />
                  </div>
    
                  <div class="form-outline mb-4">
                  <label class="form-label" for="form3Example3cg">Your Phone</label>  
                  <input type="number" name="phone" value = "<?php echo $empolyee['phone']; ?>" class="form-control form-control-lg" disabled/>
                  ...
                  <input type="text" name="designation" value = "<?php echo $empolyee['designation']; ?>"class="form-control form-control-lg" disabled/>
                    
                  </div>
    
                  <div class="form-outline mb-4">
                  <label class="form-label" for="form3Example4cdg">Salary Rate</label>  
                  <input type="text" name="salary" value = "<?php echo $empolyee['salaryRate']; ?>" class="form-control form-control-lg" disabled/>
                    
                  </div>
    
                  <div class="form-outline mb-4">
                  <label class="form-label" for="form3Example4cdg">Date of Birth</label>  
                  <input type="date" name="date" value = "<?php echo $empolyee['dob']; ?>" class="form-control form-control-lg" disabled/>
                  ...
                  <div class="d-flex justify-content-center">
                    <a button  href = "adminHomepage.php"
      ...
      <form style="padding: 10%;" >
              ...
              <div class="d-flex justify-content-center">
                <a button name="save_employee" href = "employeeHomepage.php"
                  class="btn btn-success btn-block btn-lg gradient-custom-4 text-body">Back</button> </a>
              </div>
