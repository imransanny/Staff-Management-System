        ...
        <ol>
          ...
          <li>স্টাফ</li>
            ...
            <div style="text-align: center; background: linear-gradient(180deg, #d5a8a8, #263550);">
                ...
                <h1  class="h3 mb-3 fw-normal">প্রবেশ সময় / প্রস্থান সময়</h1>

                <div class="form-floating">
                <input type="time" class="form-control" name= "enter" id="floatingInput" placeholder="name@example.com">
                <label for="floatingInput">প্রবেশ সময়</label>
                </div>
                <div class="form-floating">
                <input type="time" class="form-control" name = "exit" id="floatingPassword" placeholder="Password">
                <label for="floatingPassword">প্রস্থান সময়</label>
                </div>

                
                <button class="w-100 btn btn-lg btn-primary" type="submit" name = "workInput">জমা দিন</button>
