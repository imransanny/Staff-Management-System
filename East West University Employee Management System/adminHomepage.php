        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item  position-relative">
              ...
              <a href="employeeList.php" class="readmore stretched-link">আরও দেখুন <i class="bi bi-arrow-right"></i></a>
            </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item position-relative">
              ...
              <h3>কর্মচারী স্যালারি</h3>
              <p>প্রত্যেক কর্মচারীর কাজের ধরণভেদে ঘন্টায় একটি স্যালারি রেট থাকবে, সম্পন্ন কাজের সময় থেকে তাদের স্যালারি হিসেব করা হবে। </p>
              <a href="employeeSalaryList.php" class="readmore stretched-link">আরও দেখুন <i class="bi bi-arrow-right"></i></a>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="service-item position-relative">
              ...
              <a href="workhourList.php" class="readmore stretched-link">আরও দেখুন <i class="bi bi-arrow-right"></i></a>
            </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="service-item position-relative">
              ...
              <h3>অনুষ্ঠান যোগ করুন</h3>
              <p>প্রত্যেক কর্মচারীর একটি করে আলাদা প্রোফাইল থাকবে। এই প্রোফাইলে কর্মচারীর ব্যক্তিগত সব তথ্য সেভ করা থাকবে। </p>
              <a href="addEvent.php" class="readmore stretched-link">আরও দেখুন <i class="bi bi-arrow-right"></i></a>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div class="service-item position-relative">
              ...
              <h3>কর্মচারী যোগ করুন</h3>
              <p>ডেটাবেজলিস্টে প্রতিটি কর্মচারীর আইডি, নাম, ফোন নাম্বার, প্রোফাইলের লিংক, কাজের সময়, স্যালারি সবকিছুর রেকর্ড থাকবে। </p>
              <a href="signUp.php" class="readmore stretched-link">আরও দেখুন <i class="bi bi-arrow-right"></i></a>
            </div>
          </div><!-- End Service Item -->
