        ...
        *, ::after, ::before {
        ...
        form{
            ...
            display: inline-block;
                ...
                width: 50%;
                height: 200px;
                background-color: linear-gradient(180deg, #7ab3f8, #94dff8);
                margin: 10px;
                }
...
<body>
  ...
  <main id="main">
    ...
    <div style="background-color: linear-gradient(180deg, #7ab3f8, #94dff8);" > 
                  <h1 style="text-align: center; margin-top: 3%; color: brown; font-weight: bold;" >নতুন ইভেন্ট </h1>
            <div class="card-grid" style="background-color: linear-gradient(180deg, #7ab3f8, #94dff8);">
                <div class="card-row">
      <?php 
          ...
          if(mysqli_num_rows($query_run) > 0){
            foreach($query_run as $event){
                  ...
                  echo '<div class="card" style="background-color: linear-gradient(180deg, #7ab3f8, #94dff8);">';
                  echo '  <h3 style="text-align: center;" >' . $event['name'] . '</h3>';
                  echo '  <h4 style="text-align: center;">' . $event['venue'] . '</h4>';
                  echo '  <p style="text-align: center;">' . $event['date'] . '</p>';
                  echo '</div>';
                  $count++;
                  if($count == 3){
                    echo '</div>';
